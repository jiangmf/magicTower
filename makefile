...
CFLAGS=-g -Wall -std=c++0x -w
#-static-libgcc -static-libstdc++ -lfreeglut_static
CC=g++
EXEEXT=
RM=rm
...
$(PROGRAM_NAME): main.cpp texture.h entity.h model.h layout.h material.h
	$(CC) -o $@$(EXEEXT) $^ $(CFLAGS) $(LDFLAGS)
